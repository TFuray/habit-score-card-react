const ListItem = ({ item, handleBadSwitch, handleGoodSwitch }) => {
  return (
    <li className='flex gap-x-8 gap-y-4 justify-between'>
      ...
      <button onClick={() => handleGoodSwitch(item.id)} className="btn btn-outline btn-secondary btn-sm">Good Habit</button>
    </li>
  )
}
